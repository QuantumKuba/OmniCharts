...
export default async function handler(req, res) {
  ...
  try {
    // For debugging
    console.log('[API] Klines endpoint hit');
    ...
    console.log(`[API] Forwarding request to: ${binanceUrl}`);
    ...
    if (!response.ok) {
      console.error(`[API] Binance API responded with status: ${response.status}`);
